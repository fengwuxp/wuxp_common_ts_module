...
import {ProxyServiceFactory} from "../proxy/ProxyServiceFactory";
...
export default class BuilderProxyServiceUtil {
    ...
    public static build<T extends ProxyApiService>(apiService: T): T {
        ...
        if (RUN_ENV === RunEnv.WEEX) {
            //weex中需要使用es5的代理
            builder = require("../proxy/Es5PoxyServiceFactory").default;
        } else {
            builder = require("../proxy/Es6PoxyServiceFactory").default;
        }
