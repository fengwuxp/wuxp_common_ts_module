...
// infinite loop, because it iterates over the newly added props too.
    ...
    /**
     * Sets the value for multiple memberStyles on a node.  If a value is specified as
    ...
    function diffProperties$1(domElement, tag, lastRawProps, nextRawProps, rootContainerElement) {
        ...
        for (propKey in nextProps) {
            ...
            if (propKey === STYLE) {
                ...
                if (lastProp) {
                    // Unset memberStyles on `lastProp` but not on `nextProp`.
                    ...
                    // Update memberStyles that changed since `lastProp`.
