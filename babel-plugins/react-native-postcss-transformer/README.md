...
# fork https://github.com/kristerkari/react-native-postcss-transformer
```  
     // add rectNativeTransformerCss option
     const rectNativeTransformerCss = options.rectNativeTransformerCss || defaultRectNativeTransformerCss;
```
